...
\begin{center}
	\fbox{\includegraphics[width=\textwidth]{bdd_image.png}}
...
\begin{center}
	\fbox{\includegraphics[width=\textwidth]{ibd_image.png}}
...
The DataReader is in charge for actually being notified of data. This object subscribes to a Topic and will receive all messages published for this topic (if they are not filtered 
